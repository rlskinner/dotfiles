...
au FileType pm :map <F1> :call CommentToggleSmart("0", "# ")<CR>
au FileType pl :map <F1> :call CommentToggleSmart("0", "# ")<CR>
au FileType c :map <F1> :call CommentToggleSmart("0", '/* ', ' */')<CR>
au FileType cpp :map <F1> :call CommentToggleSmart("0", '// ')<CR>
au FileType c++ :map <F1> :call CommentToggleSmart("0", '// ')<CR>
au FileType html :map <F1> :call CommentToggleSmart("0", "<!-- ", ' -->')<CR>
au FileType slang :map <F1> :call CommentToggleSmart("0", '% ')<CR>
au FileType slrnrc :map <F1> :call CommentToggleSmart("0", '% ')<CR>
au FileType slrnsc :map <F1> :call CommentToggleSmart("0", '% ')<CR>
au FileType tex :map <F1> :call CommentToggleSmart("0", '% ')<CR>
au FileType vim :map <F1>  :call CommentToggleSmart("0", '" ')<CR>
au FileType xdefaults :map <F1> :call CommentToggleSmart("0", '! ')<CR>
